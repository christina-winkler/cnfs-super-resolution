...
def main(args):
    ...
    if args.modelname is None:
        args.modelname = "{}_{}_bsz{}_K{}_L{}_lr{:.4f}_s{}".format(args.model,              args.trainset, args.bsz, args.K,
                          args.L, args.lr, args.s)
    ...
    if args.modeltype == 'flow':
        ...
        3, args.crop_size, args.crop_size), args.filter_size,
        args.L, args.K, args.bsz, args.s, args.nb, args.condch,
        args.nbits, args.noscale, args.noscaletest)
    ...
    if args.modeltype == 'dlogistic':
        model = dlogistic.DLogistic_NN(
            ...
            args.s, args.L, args.K, args.bsz, args.nb, args.nbits)
    ...
    if args.train:
        if args.resume_training:
            ...
            model, optimizer, epoch = utils.load_model(model, optimizer,
                                                       args.model_path,
                                                       args.modelname,
                                                       args.trainset)
        ...
        if args.modeltype == 'dlogistic':
            trainer_baseline.trainer_baseline(args, train_loader,
                             valid_loader,
                             test_loader, model, optimizer, device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--K', type=int, default=8,
                        help='# of flow steps, model depth')
    parser.add_argument('--nb', type=int, default=16,
                        help='# of residual-in-residual blocks LR NW.')
