...
def trainer_baseline(args, train_loader, valid_loader, test_loader, model, optimizer, device, needs_init=True):
    ...
    for epoch in range(args.epochs):
        for batch_idx, item in enumerate(train_loader):
            ...
            print("[{}] Train Step: {:01d}/{}, Bsz = {}, Average bpd {:.3f}".format(
